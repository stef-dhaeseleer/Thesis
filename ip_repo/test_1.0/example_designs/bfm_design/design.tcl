proc create_ipi_design { offsetfile design_name } {
	...
	connect_bd_intf_net [get_bd_intf_pins master_0/M_AXI ] [get_bd_intf_pins test_0/S00_AXI]
...
set_property -name {xsim.simulate.runtime} -value {100ms} -objects [get_filesets sim_1]
	...
	set offset_file "${bd_path}/test_v1_0_tb_include.svh"
...
set test_bench_file ${ip_path}/example_designs/bfm_design/test_v1_0_tb.sv
