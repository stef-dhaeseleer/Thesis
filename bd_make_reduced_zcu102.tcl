set name "reduced_round_four_cores_axi_" 
set type "reduced_round_four_cores_axi"
set init 0
...
apply_bd_automation -rule xilinx.com:bd_rule:axi4 -config {Slave "/reduced_round_four_cores_axi_0/S00_AXI" intc_ip "/ps8_0_axi_periph" Clk_xbar "Auto" Clk_master "Auto" Clk_slave "Auto" }  [get_bd_intf_pins zynq_ultra_ps_e_0/M_AXI_HPM0_FPD]
