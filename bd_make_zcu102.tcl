...
for {set count 0} {$count < 64} {incr count} {
    ...
    apply_bd_automation -rule xilinx.com:bd_rule:axi4 -config {Slave "/"$a"/S00_AXI" intc_ip "/ps8_0_axi_periph" Clk_xbar "Auto" Clk_master "Auto" Clk_slave "Auto" }  [get_bd_intf_pins zynq_ultra_ps_e_0/M_AXI_HPM1_FPD]
    endgroup
}
